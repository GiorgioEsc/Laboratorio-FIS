...
public class SQLiteJDBCDriverConnection {
    ...
    Statement stmt = null;
    String url = "jdbc:sqlite:C:\\Users\\Toño\\Desktop\\CajeroAutomatico\\baseDatosBancaria.db";
    ...
    public void actualizarTodosDatos(Cliente cliente, TarjetaDebito tarjetaDeb, Cuenta cuenta) {
        try {
            ...
            String sqlActCuenta = "update Cuenta set intentosAcceso = " + cuenta.getIntentosAcceso() + ", saldoActual = " + cuenta.getSaldoActual() + " where idCuenta = " + cuenta.getIdCuenta() + ";";
